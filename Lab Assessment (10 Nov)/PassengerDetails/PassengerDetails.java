...
public class PassengerDetails{
    public static void main(String[] args) {
        ...
        */
        BookPassenger b1 = new BookPassenger(12, 1, "Kaustubh",30, true);
        BookPassenger b2 = new BookPassenger(13, 2, "Sakshi",29, false);
        BookPassenger b3 = new BookPassenger(14, 3, "Devang",14, false);
        b1.CustomerDetails();
        b2.CustomerDetails();
        b3.CustomerDetails();
